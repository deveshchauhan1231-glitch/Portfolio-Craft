...
main { width: min(1080px, calc(100% - 132px)); margin: 0 40px 0 auto; }
...
.heroPanel { border: 1px solid color-mix(in srgb, var(--primary), transparent 55%); border-radius: 12px; background: color-mix(in srgb, var(--surface), var(--bg) 22%); box-shadow: var(--shadow); overflow: hidden; }
...
@media (max-width: 860px) {
  ...
  nav { display: none; }
  .rail { display: none; }
  main { width: min(100% - 32px, 720px); margin: auto; }
